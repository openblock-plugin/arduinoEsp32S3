...
/**
 * OpenBlock blocks to interact with a Arduino esp32s3 peripheral.
 */
class OpenBlockArduinoEsp32S3Device {
    ...
    get PINS_MENU () {
        return [
            ...
            // IO19 and IO20 are wired to USB D-/D+ (default USBMode=hwcdc);
            // using them as regular GPIOs will break USB communication and uploading.
            // {
            //     text: 'IO19',
            //     value: Pins.IO19
            // },
            ...
            // IO35 to IO37 are used by the ESP32-S3 octal SPI PSRAM on R8 modules,
            // not available as general-purpose GPIOs.
            // {
            //     text: 'IO35',
            //     value: Pins.IO35
            // },
    ...
    get ANALOG_PINS_MENU () {
        return [
            ...
            // IO11-IO20 are ADC2 channels and cannot be read while Wi-Fi is active,
            // so only ADC1 pins (IO1-IO10) are exposed here.
        ];
    }
    ...
    constructor (runtime) {
        ...
        // Create a new Arduino esp32s3 peripheral instance
        ...
        return [
            {
                ...
                name: formatMessage({
                    ...
                    default: 'Pins',
                    description: 'The name of the esp32s3 arduino device pin category'
                }),
                color1: '#4C97FF',
                color2: '#3373CC',
                color3: '#3373CC',
                ...
                blocks: [
                    ...
                    },
                    {
                        opcode: 'setPwmOutput',
                        text: formatMessage({
                            id: 'arduinoEsp32S3.pins.setPwmOutput',
                    ...
                    },
                    {
                        opcode: 'readTouchPin',
                        text: formatMessage({
                            id: 'arduinoEsp32S3.pins.readTouchPin',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoEsp32S3.pins.attachInterrupt',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoEsp32S3.pins.detachInterrupt',
            ...
            },
            {
                ...
                name: formatMessage({
                    ...
                    default: 'Serial',
                    description: 'The name of the arduino esp32s3 device serial category'
                }),
                color1: '#9966FF',
                color2: '#774DCB',
                color3: '#774DCB',
            ...
            },
            {
                ...
                name: formatMessage({
                    ...
                    default: 'Data',
                    description: 'The name of the arduino esp32s3 device data category'
                }),
                color1: '#CF63CF',
                color2: '#C94FC9',
                color3: '#BD42BD',
